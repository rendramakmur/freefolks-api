...
return new class extends Migration
{
    ...
    {
        Schema::create('game_registred_player', function (Blueprint $table) {
            ...
            $table->decimal('grp_amount_paid', 10, 2)->nullable();
            ...
            $table->timestamp('grp_updated_at')->useCurrent()->nullable()->default(DB::raw('now()'));
        });
    }
    ...
    {
        Schema::dropIfExists('game_registred_player');
    }
};

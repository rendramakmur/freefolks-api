...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('game_information', function (Blueprint $table) {
            ...
            $table->integer('gi_type')->unsigned()->nullable()->comment('reference to mr_global_param - mr_game_info');
            ...
            $table->timestamp('gi_updated_at')->useCurrent()->nullable()->default(DB::raw('now()'));
        });
    }
